...
class ProcessAccountsPayableFinancialAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_accounts_payable(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Process accounts_payable task with AI-powered analysis.

        Implements APQC process: Process Accounts Payable
        Domain: financial
        ...
        processor = get_processor("financial")

        # Prepare context for processing
        processing_context = {
            "apqc_process": "Process Accounts Payable",
        ...
        if not analysis_results:
            analysis_results = {
                ...
                "domain": processing_result.get("domain", "financial"),
