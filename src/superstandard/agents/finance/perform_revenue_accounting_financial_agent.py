...
class PerformRevenueAccountingFinancialAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_financial(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "8.2 Perform revenue accounting",
...
def create_perform_revenue_accounting_financial_agent(
    config: Optional[PerformRevenueAccountingFinancialAgentConfig] = None,
