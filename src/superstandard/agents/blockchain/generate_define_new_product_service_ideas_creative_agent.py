...
class GenerateDefineNewProductServiceIdeasCreativeAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_creative(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "2.2 Generate and define new product/service ideas",
...
def create_generate_define_new_product_service_ideas_creative_agent(
    config: Optional[GenerateDefineNewProductServiceIdeasCreativeAgentConfig] = None,
