...
class TestMarketForNewProductsServicesCreativeAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_creative(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "2.4 Test market for new products/services",
...
def create_test_market_for_new_products_services_creative_agent(
    config: Optional[TestMarketForNewProductsServicesCreativeAgentConfig] = None,
