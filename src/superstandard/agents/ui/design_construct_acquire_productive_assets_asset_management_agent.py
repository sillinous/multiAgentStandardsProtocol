...
class DesignConstructAcquireProductiveAssetsAssetManagementAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_asset_management(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Process asset_management task with AI-powered analysis.
        ...
        processor = get_processor("asset_management")

        # Prepare context for processing
        processing_context = {
            "apqc_process": "9.1 Design and construct/acquire productive assets",
        ...
        if not analysis_results:
            analysis_results = {
                ...
                "domain": processing_result.get("domain", "asset_management"),
...
def create_design_construct_acquire_productive_assets_asset_management_agent(
    config: Optional[DesignConstructAcquireProductiveAssetsAssetManagementAgentConfig] = None,
