"""
UnderstandMarkets,Customers,CapabilitiesSalesMarketingAgent - APQC 3.0 Agent

3.1 Understand markets, customers, and capabilities

This agent implements APQC process 3.0.1 from category 3.0: Market and Sell Products and Services.
...
APQC Blueprint ID: apqc_3_0_14a864bd
APQC Category: 3.0 - Market and Sell Products and Services
APQC Process: 3.0.1 - 3.1 Understand markets, customers, and capabilities
...
@dataclass
class UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig:
    """Configuration for UnderstandMarkets,Customers,CapabilitiesSalesMarketingAgent"""

    # APQC Metadata
    apqc_agent_id: str = "apqc_3_0_14a864bd"
    apqc_category_id: str = "3.0"
    apqc_category_name: str = "Market and Sell Products and Services"
    apqc_process_id: str = "3.0.1"
    apqc_process_name: str = "3.1 Understand markets, customers, and capabilities"

    # Agent Identity
    agent_id: str = "apqc_3_0_14a864bd"
    agent_name: str = "understand_markets,_customers,_capabilities_sales_marketing_agent"
    ...
    @classmethod
    def from_environment(cls) -> "UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig":
        """Create configuration from environment variables (Redeployable)"""
        return cls(
            agent_id=os.getenv("AGENT_ID", "apqc_3_0_14a864bd"),
...
class UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent(BaseAgent, ProtocolMixin):
    """
    UnderstandMarkets,Customers,CapabilitiesSalesMarketingAgent - APQC 3.0 Agent
    ...
    APQC_AGENT_ID = "apqc_3_0_14a864bd"
    APQC_CATEGORY_ID = "3.0"
    APQC_PROCESS_ID = "3.0.1"
    APQC_FRAMEWORK_VERSION = "7.0.1"

    def __init__(self, config: UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig):
        """Initialize agent"""
        super().__init__(
        ...
        self.config = config
        self.capabilities_list = ['analysis', 'decision_making', 'communication', 'collaboration', 'learning', 'market_analysis', 'campaign_management', 'lead_generation']
        ...
        self.integration = {'compatible_agents': ['1.0', '2.0', '6.0'], 'required_services': ['knowledge_graph', 'vector_db', 'event_bus', 'nlp_service'], 'ontology_level': 'L2_process'}
    ...
    @classmethod
    def from_environment(cls) -> "UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent":
        """Create agent from environment variables (Redeployable)"""
        config = UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig.from_environment()
        return cls(config)
    ...
    async def _process_sales_marketing(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Implements APQC process: 3.1 Understand markets, customers, and capabilities
        Domain: marketing_sales
        ...
        processing_context = {
            "apqc_process": "3.1 Understand markets, customers, and capabilities",
...
def create_understand_markets_customers_capabilities_sales_marketing_agent(config: Optional[UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig] = None) -> UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent:
    """Create UnderstandMarkets,Customers,CapabilitiesSalesMarketingAgent instance"""
    if config is None:
        config = UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig()
    return UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent(config)
