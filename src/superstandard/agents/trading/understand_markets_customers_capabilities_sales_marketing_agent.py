"""
UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent - APQC 3.0 Agent
...
class UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig:
    """Configuration for UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent"""
...
def create_understand_markets_customers_capabilities_sales_marketing_agent(
    config: Optional[UnderstandMarketsCustomersCapabilitiesSalesMarketingAgentConfig] = None,
) -> UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent:
    """Create UnderstandMarketsCustomersCapabilitiesSalesMarketingAgent instance"""
    if config is None:
