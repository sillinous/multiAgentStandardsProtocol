...
class DevelopMarketingStrategySalesMarketingAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_sales_marketing(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "3.2 Develop marketing strategy",
...
def create_develop_marketing_strategy_sales_marketing_agent(
    config: Optional[DevelopMarketingStrategySalesMarketingAgentConfig] = None,
