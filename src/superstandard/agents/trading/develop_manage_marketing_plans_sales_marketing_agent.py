...
class DevelopManageMarketingPlansSalesMarketingAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_sales_marketing(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "3.4 Develop and manage marketing plans",
...
def create_develop_manage_marketing_plans_sales_marketing_agent(
    config: Optional[DevelopManageMarketingPlansSalesMarketingAgentConfig] = None,
