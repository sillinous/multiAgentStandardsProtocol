...
class DevelopBusinessStrategyStrategicAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_strategic(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "1.2 Develop business strategy",
...
def create_develop_business_strategy_strategic_agent(
    config: Optional[DevelopBusinessStrategyStrategicAgentConfig] = None,
