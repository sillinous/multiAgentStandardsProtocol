...
class ManageProductPortfolioSalesMarketingAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_portfolio_management(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Process portfolio_management task with AI-powered analysis.

        Implements APQC process: 3.2.3 Manage Product Portfolio
        Domain: sales_marketing
        ...
        processing_context = {
            "apqc_process": "3.2.3 Manage Product Portfolio",
