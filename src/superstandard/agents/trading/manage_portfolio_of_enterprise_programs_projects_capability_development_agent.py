...
12.2 Manage portfolio of enterprise programs/projects

This agent implements APQC process 12.0.2 from category 12.0: Develop and Manage Business Capabilities.
...
APQC Blueprint ID: apqc_12_0_d7483368
APQC Category: 12.0 - Develop and Manage Business Capabilities
APQC Process: 12.0.2 - 12.2 Manage portfolio of enterprise programs/projects
...
@dataclass
class ManagePortfolioOfEnterpriseProgramsProjectsCapabilityDevelopmentAgentConfig:
    """Configuration for ManagePortfolioOfEnterpriseProgramsProjectsCapabilityDevelopmentAgent"""

    # APQC Metadata
    apqc_agent_id: str = "apqc_12_0_d7483368"
    apqc_category_id: str = "12.0"
    apqc_category_name: str = "Develop and Manage Business Capabilities"
    apqc_process_id: str = "12.0.2"
    apqc_process_name: str = "12.2 Manage portfolio of enterprise programs/projects"
...
class ManagePortfolioOfEnterpriseProgramsProjectsCapabilityDevelopmentAgent(
    ...
    APQC_AGENT_ID = "apqc_12_0_d7483368"
    ...
    async def _process_capability_development(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Implements APQC process: 12.2 Manage portfolio of enterprise programs/projects
        Domain: process_improvement
        ...
        processing_context = {
            "apqc_process": "12.2 Manage portfolio of enterprise programs/projects",
...
def create_manage_portfolio_of_enterprise_programs_projects_capability_development_agent(
    ...
    return ManagePortfolioOfEnterpriseProgramsProjectsCapabilityDevelopmentAgent(config)
