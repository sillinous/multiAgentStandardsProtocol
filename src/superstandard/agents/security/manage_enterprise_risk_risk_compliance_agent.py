...
class ManageEnterpriseRiskRiskComplianceAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_risk_compliance(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "10.2 Manage enterprise risk",
...
def create_manage_enterprise_risk_risk_compliance_agent(
    config: Optional[ManageEnterpriseRiskRiskComplianceAgentConfig] = None,
