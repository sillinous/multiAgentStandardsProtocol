...
class ManageBusinessPoliciesProceduresRiskComplianceAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_risk_compliance(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "10.1 Manage business policies and procedures",
...
def create_manage_business_policies_procedures_risk_compliance_agent(
    config: Optional[ManageBusinessPoliciesProceduresRiskComplianceAgentConfig] = None,
