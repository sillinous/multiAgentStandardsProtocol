"""
ManageBusinessOfItTechnologyAgent - APQC 13.0 Agent

13.1 Manage the business of IT

This agent implements APQC process 13.0.1 from category 13.0: Manage Information Technology.
...
APQC Blueprint ID: apqc_13_0_736c1a52
APQC Category: 13.0 - Manage Information Technology
APQC Process: 13.0.1 - 13.1 Manage the business of IT
...
@dataclass
class ManageBusinessOfItTechnologyAgentConfig:
    """Configuration for ManageBusinessOfItTechnologyAgent"""

    # APQC Metadata
    apqc_agent_id: str = "apqc_13_0_736c1a52"
    apqc_category_id: str = "13.0"
    apqc_category_name: str = "Manage Information Technology"
    apqc_process_id: str = "13.0.1"
    apqc_process_name: str = "13.1 Manage the business of IT"

    # Agent Identity
    agent_id: str = "apqc_13_0_736c1a52"
    agent_name: str = "manage_business_of_it_technology_agent"
    ...
    @classmethod
    def from_environment(cls) -> "ManageBusinessOfItTechnologyAgentConfig":
...
class ManageBusinessOfItTechnologyAgent(BaseAgent, ProtocolMixin):
    """
    ManageBusinessOfItTechnologyAgent - APQC 13.0 Agent
    ...
    APQC_AGENT_ID = "apqc_13_0_736c1a52"
    APQC_CATEGORY_ID = "13.0"
    APQC_PROCESS_ID = "13.0.1"
    ...
    @classmethod
    def from_environment(cls) -> "ManageBusinessOfItTechnologyAgent":
        """Create agent from environment variables (Redeployable)"""
        config = ManageBusinessOfItTechnologyAgentConfig.from_environment()
        return cls(config)
    ...
    async def _process_technology(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Implements APQC process: 13.1 Manage the business of IT
        Domain: information_technology
        ...
        processing_context = {
            "apqc_process": "13.1 Manage the business of IT",
...
def create_manage_business_of_it_technology_agent(
    ...
    return ManageBusinessOfItTechnologyAgent(config)
