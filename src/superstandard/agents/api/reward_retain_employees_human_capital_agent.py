...
class RewardRetainEmployeesHumanCapitalAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_human_capital(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "7.4 Reward and retain employees",
...
def create_reward_retain_employees_human_capital_agent(
    config: Optional[RewardRetainEmployeesHumanCapitalAgentConfig] = None,
