...
class GovernManageProductServiceDevelopmentCreativeAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_creative(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "2.1 Govern and manage product/service development",
...
def create_govern_manage_product_service_development_creative_agent(
    config: Optional[GovernManageProductServiceDevelopmentCreativeAgentConfig] = None,
