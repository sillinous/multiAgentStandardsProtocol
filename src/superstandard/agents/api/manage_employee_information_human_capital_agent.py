...
class ManageEmployeeInformationHumanCapitalAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_human_capital(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "7.6 Manage employee information",
...
def create_manage_employee_information_human_capital_agent(
    config: Optional[ManageEmployeeInformationHumanCapitalAgentConfig] = None,
