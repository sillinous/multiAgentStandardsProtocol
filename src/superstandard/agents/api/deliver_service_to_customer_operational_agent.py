...
class DeliverServiceToCustomerOperationalAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_operational(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "4.4 Deliver service to customer",
...
def create_deliver_service_to_customer_operational_agent(
    config: Optional[DeliverServiceToCustomerOperationalAgentConfig] = None,
