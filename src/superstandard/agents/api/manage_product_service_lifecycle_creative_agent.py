...
class ManageProductServiceLifecycleCreativeAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_creative(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "2.6 Manage product/service lifecycle",
...
def create_manage_product_service_lifecycle_creative_agent(
    config: Optional[ManageProductServiceLifecycleCreativeAgentConfig] = None,
