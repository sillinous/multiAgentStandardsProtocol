...
class DevelopCounselEmployeesHumanCapitalAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_human_capital(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "7.3 Develop and counsel employees",
...
def create_develop_counsel_employees_human_capital_agent(
    config: Optional[DevelopCounselEmployeesHumanCapitalAgentConfig] = None,
