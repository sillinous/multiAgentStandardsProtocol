...
class ProcureMaterialsServicesOperationalAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_operational(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "4.2 Procure materials and services",
...
def create_procure_materials_services_operational_agent(
    config: Optional[ProcureMaterialsServicesOperationalAgentConfig] = None,
