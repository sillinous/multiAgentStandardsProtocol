...
class DevelopManageInnovationStrategicAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_strategic(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "1.4 Develop and manage innovation",
...
def create_develop_manage_innovation_strategic_agent(
    config: Optional[DevelopManageInnovationStrategicAgentConfig] = None,
