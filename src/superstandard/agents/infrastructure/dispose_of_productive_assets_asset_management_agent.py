...
class DisposeOfProductiveAssetsAssetManagementAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_asset_management(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "9.3 Dispose of productive assets",
...
def create_dispose_of_productive_assets_asset_management_agent(
    config: Optional[DisposeOfProductiveAssetsAssetManagementAgentConfig] = None,
