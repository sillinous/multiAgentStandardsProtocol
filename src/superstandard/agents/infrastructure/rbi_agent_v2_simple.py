...
# DeepSeek client
deepseek_client = OpenAI(api_key=os.getenv("DEEPSEEK_KEY"), base_url="https://api.deepseek.com")
...
def research_strategy(content):
    ...
    output = run_with_animation(
        chat_with_deepseek, "Research AI", RESEARCH_PROMPT, content, "deepseek-chat"
    )
