...
# Video Settings
RAW_VIDS_DIR = Path(
    "/Users/md/Dropbox/dev/github/moon-dev-ai-agents-for-trading/src/data/videos/raw_vids"
)
...
# Output Settings
AUDIO_DIR = Path(
    "/Users/md/Dropbox/dev/github/moon-dev-ai-agents-for-trading/src/data/videos/audio"
)
        ...
        try:
            ...
            for i, line in enumerate(text_lines, 1):
                ...
                try:
                    ...
                    audio = elevenlabs.generate(text=line, voice=VOICE_ID, model=MODEL_ID)
