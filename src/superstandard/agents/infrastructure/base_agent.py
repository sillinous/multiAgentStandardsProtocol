"""
🌙 Moon Dev's Trading Base Agent - SPECIALIZED FOR TRADING

⚠️ NOTICE: This is a TRADING-SPECIFIC base agent from Moon Dev
   - Use for trading agents that need ExchangeManager
   - For general agents, use: agents.consolidated.py.base_agent_v1.BaseAgent (CANONICAL)

Parent class for all trading agents with unified exchange support.
Provides ExchangeManager integration for Solana/other exchanges.

Location: agents/trading/base_agent.py (relocated from consolidated/py/)
"""
