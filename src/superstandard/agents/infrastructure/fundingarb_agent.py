            ...
            if self.deepseek_client and MODEL_OVERRIDE.lower() == "deepseek-chat":
                ...
                response = self.deepseek_client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "You are a funding arbitrage analyst. You must respond in exactly 2 lines: ARBITRAGE/SKIP and your reason.",
                        },
                        {
                            "role": "user",
                            "content": FUNDING_ANALYSIS_PROMPT.format(
                                market_data=context, threshold=YEARLY_FUNDING_THRESHOLD
                            ),
                        },
                    ],
