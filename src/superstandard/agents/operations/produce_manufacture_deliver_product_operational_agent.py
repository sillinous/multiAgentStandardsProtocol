...
class ProduceManufactureDeliverProductOperationalAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_operational(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "4.3 Produce/Manufacture/Deliver product",
...
def create_produce_manufacture_deliver_product_operational_agent(
    config: Optional[ProduceManufactureDeliverProductOperationalAgentConfig] = None,
