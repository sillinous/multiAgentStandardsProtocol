...
class ManageLogisticsWarehousingOperationalAgent(BaseAgent, ProtocolMixin):
    ...
    async def _process_operational(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        processing_context = {
            "apqc_process": "4.5 Manage logistics and warehousing",
...
def create_manage_logistics_warehousing_operational_agent(
    config: Optional[ManageLogisticsWarehousingOperationalAgentConfig] = None,
