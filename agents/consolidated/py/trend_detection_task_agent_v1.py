...
class TrendDetectionTaskAgent(BaseAgent):
    """
    Trend Detection Task Agent
    ...
    def __init__(self, agent_id: str = "trend_detection_task_agent", config: Optional[Dict[str, Any]] = None):
        """
        Initialize Trend Detection Task Agent
        ...
        logger.info(f"Initialized Trend Detection Task Agent [{self.agent_id}]")
...
- statistical_significance: dict
    ...
    def _validate_inputs(self, task: Dict[str, Any]) -> None:
        ...
        """
        required_fields = ['time_series', 'detection_params']
...
# Example usage
async def main():
    """Example usage of Trend Detection Task Agent"""

    # Create agent instance
    agent = TrendDetectionTaskAgent()
