...
def create_plan_for_align_supply_chain_resources_operational_agent(config: Optional[PlanForAlignSupplyChainResourcesOperationalAgentConfig] = None) -> PlanForAlignSupplyChainResourcesOperationalAgent:
