...
def create_develop_manage_sales_plans_sales_marketing_agent(config: Optional[DevelopManageSalesPlansSalesMarketingAgentConfig] = None) -> DevelopManageSalesPlansSalesMarketingAgent:
