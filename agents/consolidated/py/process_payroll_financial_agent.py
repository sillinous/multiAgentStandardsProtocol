"""
ProcessPayrollFinancialAgent - APQC 8.0 Agent

8.5 Process payroll

This agent implements APQC process 8.0.5 from category 8.0: Manage Financial Resources.
...
APQC Blueprint ID: apqc_8_0_78d551b7
APQC Category: 8.0 - Manage Financial Resources
APQC Process: 8.0.5 - 8.5 Process payroll
...
@dataclass
class ProcessPayrollFinancialAgentConfig:
    """Configuration for ProcessPayrollFinancialAgent"""

    # APQC Metadata
    apqc_agent_id: str = "apqc_8_0_78d551b7"
    apqc_category_id: str = "8.0"
    apqc_category_name: str = "Manage Financial Resources"
    apqc_process_id: str = "8.0.5"
    apqc_process_name: str = "8.5 Process payroll"

    # Agent Identity
    agent_id: str = "apqc_8_0_78d551b7"
    agent_name: str = "process_payroll_financial_agent"
    ...
    @classmethod
    def from_environment(cls) -> "ProcessPayrollFinancialAgentConfig":
        """Create configuration from environment variables (Redeployable)"""
        return cls(
            agent_id=os.getenv("AGENT_ID", "apqc_8_0_78d551b7"),
...
class ProcessPayrollFinancialAgent(BaseAgent, ProtocolMixin):
    """
    ProcessPayrollFinancialAgent - APQC 8.0 Agent
    ...
    APQC_AGENT_ID = "apqc_8_0_78d551b7"
    APQC_CATEGORY_ID = "8.0"
    APQC_PROCESS_ID = "8.0.5"
    APQC_FRAMEWORK_VERSION = "7.0.1"

    def __init__(self, config: ProcessPayrollFinancialAgentConfig):
        """Initialize agent"""
        super().__init__(
    ...
    @classmethod
    def from_environment(cls) -> "ProcessPayrollFinancialAgent":
        """Create agent from environment variables (Redeployable)"""
        config = ProcessPayrollFinancialAgentConfig.from_environment()
        return cls(config)
    ...
    async def _process_financial(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Implements APQC process: 8.5 Process payroll
        """
...
def create_process_payroll_financial_agent(config: Optional[ProcessPayrollFinancialAgentConfig] = None) -> ProcessPayrollFinancialAgent:
    """Create ProcessPayrollFinancialAgent instance"""
    if config is None:
        config = ProcessPayrollFinancialAgentConfig()
    return ProcessPayrollFinancialAgent(config)
