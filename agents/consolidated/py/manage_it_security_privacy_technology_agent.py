...
def create_manage_it_security_privacy_technology_agent(config: Optional[ManageItSecurityPrivacyTechnologyAgentConfig] = None) -> ManageItSecurityPrivacyTechnologyAgent:
