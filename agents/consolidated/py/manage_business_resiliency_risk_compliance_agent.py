...
def create_manage_business_resiliency_risk_compliance_agent(config: Optional[ManageBusinessResiliencyRiskComplianceAgentConfig] = None) -> ManageBusinessResiliencyRiskComplianceAgent:
