...
class TrackFleetLocationLogisticsAgent(BaseAgent, ProtocolMixin):
        ...
        return {
            ...
            "output": {
                ...
                "tracking_metrics": {
                    ...
                    "average_speed_kmh": round(np.mean([v.get('speed_kmh', 0) for v in vehicles]), 1),
                    "tracking_period_minutes": tracking_period
                }
            }
        }

    def _analyze_fleet_distribution(self, vehicles: List[Dict], geofences: List[Dict]) -> Dict[str, Any]:
        ...
        for geofence in geofences:
            ...
            distribution[zone_id] = {
                ...
                'coverage_percentage': round((vehicles_in_zone / len(vehicles) * 100), 1) if vehicles else 0
            }
        ...
        for i, vehicle in enumerate(vehicles):
            ...
            for j, other_vehicle in enumerate(vehicles):
                ...
                distance = self._haversine_distance(
                    ...
                    other_vehicle['location']['lat'], other_vehicle['location']['lng']
                )
    ...
    def _analyze_coverage(self, vehicles: List[Dict], geofences: List[Dict]) -> Dict[str, Any]:
        ...
        for geofence in geofences:
            zone_id = geofence['zone_id']
            vehicles_in_zone = sum(1 for v in vehicles if self._is_in_geofence(v['location'], geofence))
