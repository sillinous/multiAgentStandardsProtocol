...
def create_perform_general_accounting_reporting_financial_agent(config: Optional[PerformGeneralAccountingReportingFinancialAgentConfig] = None) -> PerformGeneralAccountingReportingFinancialAgent:
