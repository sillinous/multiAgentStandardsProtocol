...
class ManageCashFlowFinancialAgent(BaseAgent, ProtocolMixin):
    ...
    def _working_capital_ratios(self, ar_balance, inventory_balance, ap_balance, revenue_annual, cogs_annual):
    ...
    def _liquidity_scoring(self, current_assets, current_liabilities, quick_assets):
        ...
        return {
            ...
            "liquidity_status": "Strong" if liquidity_score >= 80 else "Adequate" if liquidity_score >= 60 else "Weak"
        }
