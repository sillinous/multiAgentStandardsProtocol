...
def create_manage_it_enterprise_architecture_technology_agent(config: Optional[ManageItEnterpriseArchitectureTechnologyAgentConfig] = None) -> ManageItEnterpriseArchitectureTechnologyAgent:
