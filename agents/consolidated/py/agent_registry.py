...
def create_agent_entry(agent_id: str, name: str, description: str, category: str, capabilities: List[str]) -> Dict[str, Any]:
    ...
    return {
        ...
        "capabilities": [{"name": cap, "description": f"{cap} capability", "inputs": [], "outputs": []} for cap in capabilities],
        "metrics": {
            "agent_id": agent_id,
            "status": "idle",
            "health_level": "healthy",
...
AGENT_REGISTRY_EXPANDED = {
    ...
    "trading_agent": create_agent_entry(
        ...
        "trading", ["market_buy", "market_sell", "get_position"]
    ),
    "autonomous_trading": create_agent_entry(
        "autonomous_trading", "Autonomous Trading",
        "Fully autonomous trading execution",
        "trading", ["execute_strategy", "manage_positions"]
    ),
    "copybot_agent": create_agent_entry(
        "copybot_agent", "Copy Bot Agent",
        "Copy trading from influencers",
        "trading", ["follow_trader", "copy_trade"]
    ),
    "sniper_agent": create_agent_entry(
        "sniper_agent", "Sniper Agent",
        "Precision trades on new launches",
        "trading", ["snipe_launch", "execute_fast"]
    ),
    "fundingarb_agent": create_agent_entry(
        "fundingarb_agent", "Funding Arbitrage",
        "Exploit funding rate differences",
        "trading", ["calculate_arb", "execute_arb"]
    ),
    ...
    "tx_agent": create_agent_entry(
        ...
        "utility", ["analyze_tx", "track_flow"]
    ),
    "shortvid_agent": create_agent_entry(
        "shortvid_agent", "Short Video Agent",
        "Short video content",
        "utility", ["create_short", "edit"]
    ),
}
