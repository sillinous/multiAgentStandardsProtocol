...
def create_manage_business_processes_capability_development_agent(config: Optional[ManageBusinessProcessesCapabilityDevelopmentAgentConfig] = None) -> ManageBusinessProcessesCapabilityDevelopmentAgent:
