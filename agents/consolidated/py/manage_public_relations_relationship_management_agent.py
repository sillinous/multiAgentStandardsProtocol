...
def create_manage_public_relations_relationship_management_agent(config: Optional[ManagePublicRelationsRelationshipManagementAgentConfig] = None) -> ManagePublicRelationsRelationshipManagementAgent:
