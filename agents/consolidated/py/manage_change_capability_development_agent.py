...
def create_manage_change_capability_development_agent(config: Optional[ManageChangeCapabilityDevelopmentAgentConfig] = None) -> ManageChangeCapabilityDevelopmentAgent:
