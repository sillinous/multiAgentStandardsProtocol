...
class MeasureEvaluateCustomerServiceOperationsCustomerServiceAgentConfig:
    ...
    @classmethod
    def from_environment(cls) -> "MeasureEvaluateCustomerServiceOperationsCustomerServiceAgentConfig":
...
class MeasureEvaluateCustomerServiceOperationsCustomerServiceAgent(BaseAgent, ProtocolMixin):
    ...
    def from_environment(cls) -> "MeasureEvaluateCustomerServiceOperationsCustomerServiceAgent":
        ...
        config = MeasureEvaluateCustomerServiceOperationsCustomerServiceAgentConfig.from_environment()
        return cls(config)
...
def create_measure_evaluate_customer_service_operations_customer_service_agent(config: Optional[MeasureEvaluateCustomerServiceOperationsCustomerServiceAgentConfig] = None) -> MeasureEvaluateCustomerServiceOperationsCustomerServiceAgent:
