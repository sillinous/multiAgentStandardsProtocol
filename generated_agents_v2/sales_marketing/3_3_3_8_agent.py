...
class Agent_3_3_3_8(AtomicAgentStandard):
    """
    Report campaigns

    APQC Task ID: 3.3.3.8
    Category: Market and Sell Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="3.3.3.8",
            name="Report campaigns",
            description="APQC 3.3.3.8: Report campaigns"
        )
        self.apqc_id = "3.3.3.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '3.3.3.8',
                'task_name': 'Report campaigns',
                'category': 'Market and Sell Products and Services',
            ...
            self.logger.info(f"Starting 3.3.3.8: Report campaigns")
            ...
            self.logger.info(f"Completed 3.3.3.8: Report campaigns in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 3.3.3.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
