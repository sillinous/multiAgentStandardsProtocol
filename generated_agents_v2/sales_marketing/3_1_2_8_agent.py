...
class Agent_3_1_2_8(AtomicAgentStandard):
    """
    Report opportunities

    APQC Task ID: 3.1.2.8
    Category: Market and Sell Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="3.1.2.8",
            name="Report opportunities",
            description="APQC 3.1.2.8: Report opportunities"
        )
        self.apqc_id = "3.1.2.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 3.1.2.8: Report opportunities")
            ...
            self.logger.info(f"Completed 3.1.2.8: Report opportunities in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 3.1.2.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
