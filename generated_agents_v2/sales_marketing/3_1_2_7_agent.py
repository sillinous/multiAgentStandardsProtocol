...
class Agent_3_1_2_7(AtomicAgentStandard):
    """
    Document opportunities

    APQC Task ID: 3.1.2.7
    Category: Market and Sell Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="3.1.2.7",
            name="Document opportunities",
            description="APQC 3.1.2.7: Document opportunities"
        )
        self.apqc_id = "3.1.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 3.1.2.7: Document opportunities")
            ...
            self.logger.info(f"Completed 3.1.2.7: Document opportunities in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 3.1.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
