...
class Agent_3_4_2_5(AtomicAgentStandard):
    """
    Review campaigns

    APQC Task ID: 3.4.2.5
    Category: Market and Sell Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="3.4.2.5",
            name="Review campaigns",
            description="APQC 3.4.2.5: Review campaigns"
        )
        self.apqc_id = "3.4.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '3.4.2.5',
                'task_name': 'Review campaigns',
                'category': 'Market and Sell Products and Services',
            ...
            self.logger.info(f"Starting 3.4.2.5: Review campaigns")
            ...
            self.logger.info(f"Completed 3.4.2.5: Review campaigns in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 3.4.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
