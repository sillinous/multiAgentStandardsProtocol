...
class Agent_3_1_1_7(AtomicAgentStandard):
    """
    Document prospects

    APQC Task ID: 3.1.1.7
    Category: Market and Sell Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="3.1.1.7",
            name="Document prospects",
            description="APQC 3.1.1.7: Document prospects"
        )
        self.apqc_id = "3.1.1.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '3.1.1.7',
                'task_name': 'Document prospects',
                'category': 'Market and Sell Products and Services',
            ...
            self.logger.info(f"Starting 3.1.1.7: Document prospects")
            ...
            self.logger.info(f"Completed 3.1.1.7: Document prospects in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 3.1.1.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
