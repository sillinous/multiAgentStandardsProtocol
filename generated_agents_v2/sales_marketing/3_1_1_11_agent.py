...
class Agent_3_1_1_11(AtomicAgentStandard):
    """
    Monitor prospects

    APQC Task ID: 3.1.1.11
    Category: Market and Sell Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="3.1.1.11",
            name="Monitor prospects",
            description="APQC 3.1.1.11: Monitor prospects"
        )
        self.apqc_id = "3.1.1.11"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '3.1.1.11',
                'task_name': 'Monitor prospects',
                'category': 'Market and Sell Products and Services',
            ...
            self.logger.info(f"Starting 3.1.1.11: Monitor prospects")
            ...
            self.logger.info(f"Completed 3.1.1.11: Monitor prospects in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 3.1.1.11: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
