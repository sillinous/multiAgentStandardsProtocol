"""
GatherInformationManageAgent - Standardized APQC Atomic Agent
================================================

APQC Task: 6.4.2.1 - Gather information
...
class GatherInformationManageAgentBusinessLogic(AtomicBusinessLogic):
    """
    Business logic for: Gather information

    This class implements the specific business logic for APQC task 6.4.2.1.
    ...
    def __init__(self, agent_id: str):
        ...
        self.base_template = BusinessLogicTemplateFactory.create_template(
            ...
            agent_id=agent_id,
            apqc_id="6.4.2.1",
            apqc_name="Gather information"
        )
        self.logger = logging.getLogger(f"GatherInformationManageAgent")

    async def validate_input(self, agent_input: AtomicAgentInput) -> tuple[bool, Optional[str]]:
        """
        Validate input for: Gather information
        ...
        if 'task_type' in input_data and input_data['task_type'] != '6.4.2.1':
            return False, f"Task type mismatch. Expected 6.4.2.1"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Executing: Gather information (6.4.2.1)")

            execution_steps = []
            result_data = {
                'apqc_task_id': '6.4.2.1',
                'apqc_task_name': 'Gather information',
                'category': 'Manage Customer Service',
            ...
            return AtomicAgentOutput(
                ...
                apqc_level5_id="6.4.2.1",
                apqc_level5_name="Gather information",
    ...
    async def _execute_step_1(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of receive customer inquiry for Gather information
        """
        from datetime import datetime
    ...
    async def _execute_step_2(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of categorize request type for Gather information
        """
        from datetime import datetime
    ...
    async def _execute_step_3(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of research issue/question for Gather information
        """
        from datetime import datetime
    ...
    async def _execute_step_4(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of provide solution or information for Gather information
        """
        from datetime import datetime
    ...
    async def _execute_step_5(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of escalate if necessary for Gather information
        """
        from datetime import datetime
    ...
    async def _execute_step_6(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of document interaction for Gather information
        """
        from datetime import datetime
    ...
    async def _execute_step_7(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of follow up with customer for Gather information
        """
        from datetime import datetime
    ...
    async def _execute_step_8(self, agent_input: AtomicAgentInput) -> Dict[str, Any]:
        ...
        Implementation of record in crm system for Gather information
        """
        from datetime import datetime
...
class GatherInformationManageAgent(StandardAtomicAgent):
    """
    Standardized Atomic Agent for: Gather information
    ...
    def declare_capability(self) -> AtomicCapability:
        ...
        return AtomicCapability(
            capability_id="cap_apqc_6_4_2_1_4493",
            capability_name="Gather information",
            description="Gather information - APQC 6.4.2.1",
            apqc_level5_id="6.4.2.1",
            apqc_level5_name="Gather information",
            apqc_category_id="6.0",
            apqc_category_name="Manage Customer Service",
    ...
    def create_business_logic(self) -> AtomicBusinessLogic:
        ...
        return GatherInformationManageAgentBusinessLogic(self.agent_id)
...
agent = GatherInformationManageAgent()

# Register with global registry
ATOMIC_AGENT_REGISTRY.register(agent)

# Export
__all__ = ['GatherInformationManageAgent', 'GatherInformationManageAgentBusinessLogic', 'agent']