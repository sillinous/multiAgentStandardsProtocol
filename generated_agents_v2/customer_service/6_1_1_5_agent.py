...
class Agent_6_1_1_5(AtomicAgentStandard):
    """
    Review tickets

    APQC Task ID: 6.1.1.5
    Category: Manage Customer Service
    ...
    def __init__(self):
        super().__init__(
            agent_id="6.1.1.5",
            name="Review tickets",
            description="APQC 6.1.1.5: Review tickets"
        )
        self.apqc_id = "6.1.1.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '6.1.1.5',
                'task_name': 'Review tickets',
                'category': 'Manage Customer Service',
            ...
            self.logger.info(f"Starting 6.1.1.5: Review tickets")
            ...
            self.logger.info(f"Completed 6.1.1.5: Review tickets in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 6.1.1.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
