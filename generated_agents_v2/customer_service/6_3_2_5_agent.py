...
class Agent_6_3_2_5(AtomicAgentStandard):
    """
    Review support

    APQC Task ID: 6.3.2.5
    Category: Manage Customer Service
    ...
    def __init__(self):
        super().__init__(
            agent_id="6.3.2.5",
            name="Review support",
            description="APQC 6.3.2.5: Review support"
        )
        self.apqc_id = "6.3.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '6.3.2.5',
                'task_name': 'Review support',
                'category': 'Manage Customer Service',
            ...
            self.logger.info(f"Starting 6.3.2.5: Review support")
            ...
            self.logger.info(f"Completed 6.3.2.5: Review support in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 6.3.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
