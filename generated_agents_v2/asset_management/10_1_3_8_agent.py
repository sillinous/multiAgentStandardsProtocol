...
class Agent_10_1_3_8(AtomicAgentStandard):
    """
    Report projects

    APQC Task ID: 10.1.3.8
    Category: Acquire, Construct, and Manage Assets
    ...
    def __init__(self):
        super().__init__(
            agent_id="10.1.3.8",
            name="Report projects",
            description="APQC 10.1.3.8: Report projects"
        )
        self.apqc_id = "10.1.3.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 10.1.3.8: Report projects")
            ...
            self.logger.info(f"Completed 10.1.3.8: Report projects in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 10.1.3.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
