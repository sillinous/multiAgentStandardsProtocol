...
class Agent_10_2_2_5(AtomicAgentStandard):
    """
    Review projects

    APQC Task ID: 10.2.2.5
    Category: Acquire, Construct, and Manage Assets
    ...
    def __init__(self):
        super().__init__(
            agent_id="10.2.2.5",
            name="Review projects",
            description="APQC 10.2.2.5: Review projects"
        )
        self.apqc_id = "10.2.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '10.2.2.5',
                'task_name': 'Review projects',
                'category': 'Acquire, Construct, and Manage Assets',
            ...
            self.logger.info(f"Starting 10.2.2.5: Review projects")
            ...
            self.logger.info(f"Completed 10.2.2.5: Review projects in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 10.2.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
