...
class Agent_10_1_1_7(AtomicAgentStandard):
    """
    Document equipment

    APQC Task ID: 10.1.1.7
    Category: Acquire, Construct, and Manage Assets
    ...
    def __init__(self):
        super().__init__(
            agent_id="10.1.1.7",
            name="Document equipment",
            description="APQC 10.1.1.7: Document equipment"
        )
        self.apqc_id = "10.1.1.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '10.1.1.7',
                'task_name': 'Document equipment',
                'category': 'Acquire, Construct, and Manage Assets',
            ...
            self.logger.info(f"Starting 10.1.1.7: Document equipment")
            ...
            self.logger.info(f"Completed 10.1.1.7: Document equipment in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 10.1.1.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
