...
class Agent_8_1_1_7(AtomicAgentStandard):
    """
    Document applications

    APQC Task ID: 8.1.1.7
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.1.1.7",
            name="Document applications",
            description="APQC 8.1.1.7: Document applications"
        )
        self.apqc_id = "8.1.1.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '8.1.1.7',
                'task_name': 'Document applications',
                'category': 'Manage Information Technology',
            ...
            self.logger.info(f"Starting 8.1.1.7: Document applications")
            ...
            self.logger.info(f"Completed 8.1.1.7: Document applications in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.1.1.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
