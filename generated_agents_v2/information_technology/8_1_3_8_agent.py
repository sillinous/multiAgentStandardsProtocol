...
class Agent_8_1_3_8(AtomicAgentStandard):
    """
    Report data

    APQC Task ID: 8.1.3.8
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.1.3.8",
            name="Report data",
            description="APQC 8.1.3.8: Report data"
        )
        self.apqc_id = "8.1.3.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '8.1.3.8',
                'task_name': 'Report data',
                'category': 'Manage Information Technology',
            ...
            self.logger.info(f"Starting 8.1.3.8: Report data")
            ...
            self.logger.info(f"Completed 8.1.3.8: Report data in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.1.3.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
