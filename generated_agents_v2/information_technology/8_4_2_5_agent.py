...
class Agent_8_4_2_5(AtomicAgentStandard):
    """
    Review systems

    APQC Task ID: 8.4.2.5
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.4.2.5",
            name="Review systems",
            description="APQC 8.4.2.5: Review systems"
        )
        self.apqc_id = "8.4.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.4.2.5: Review systems")
            ...
            self.logger.info(f"Completed 8.4.2.5: Review systems in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.4.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
