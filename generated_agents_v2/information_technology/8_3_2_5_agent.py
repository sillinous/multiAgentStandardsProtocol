...
class Agent_8_3_2_5(AtomicAgentStandard):
    """
    Review technology

    APQC Task ID: 8.3.2.5
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.3.2.5",
            name="Review technology",
            description="APQC 8.3.2.5: Review technology"
        )
        self.apqc_id = "8.3.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.3.2.5: Review technology")
            ...
            self.logger.info(f"Completed 8.3.2.5: Review technology in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.3.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
