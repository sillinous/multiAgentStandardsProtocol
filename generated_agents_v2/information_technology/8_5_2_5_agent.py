...
class Agent_8_5_2_5(AtomicAgentStandard):
    """
    Review infrastructure

    APQC Task ID: 8.5.2.5
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.5.2.5",
            name="Review infrastructure",
            description="APQC 8.5.2.5: Review infrastructure"
        )
        self.apqc_id = "8.5.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '8.5.2.5',
                'task_name': 'Review infrastructure',
                'category': 'Manage Information Technology',
            ...
            self.logger.info(f"Starting 8.5.2.5: Review infrastructure")
            ...
            self.logger.info(f"Completed 8.5.2.5: Review infrastructure in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.5.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
