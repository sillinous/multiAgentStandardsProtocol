...
class Agent_8_3_1_8(AtomicAgentStandard):
    """
    Report data

    APQC Task ID: 8.3.1.8
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.3.1.8",
            name="Report data",
            description="APQC 8.3.1.8: Report data"
        )
        self.apqc_id = "8.3.1.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.3.1.8: Report data")
            ...
            self.logger.info(f"Completed 8.3.1.8: Report data in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.3.1.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
