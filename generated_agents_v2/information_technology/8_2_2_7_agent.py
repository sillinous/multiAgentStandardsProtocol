...
class Agent_8_2_2_7(AtomicAgentStandard):
    """
    Document data

    APQC Task ID: 8.2.2.7
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.2.2.7",
            name="Document data",
            description="APQC 8.2.2.7: Document data"
        )
        self.apqc_id = "8.2.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.2.2.7: Document data")
            ...
            self.logger.info(f"Completed 8.2.2.7: Document data in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.2.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
