...
class Agent_8_3_2_8(AtomicAgentStandard):
    """
    Report technology

    APQC Task ID: 8.3.2.8
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.3.2.8",
            name="Report technology",
            description="APQC 8.3.2.8: Report technology"
        )
        self.apqc_id = "8.3.2.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '8.3.2.8',
                'task_name': 'Report technology',
                'category': 'Manage Information Technology',
            ...
            self.logger.info(f"Starting 8.3.2.8: Report technology")
            ...
            self.logger.info(f"Completed 8.3.2.8: Report technology in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.3.2.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
