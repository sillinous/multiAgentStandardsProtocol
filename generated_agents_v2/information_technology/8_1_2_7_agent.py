...
class Agent_8_1_2_7(AtomicAgentStandard):
    """
    Document security

    APQC Task ID: 8.1.2.7
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.1.2.7",
            name="Document security",
            description="APQC 8.1.2.7: Document security"
        )
        self.apqc_id = "8.1.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '8.1.2.7',
                'task_name': 'Document security',
                'category': 'Manage Information Technology',
            ...
            self.logger.info(f"Starting 8.1.2.7: Document security")
            ...
            self.logger.info(f"Completed 8.1.2.7: Document security in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.1.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
