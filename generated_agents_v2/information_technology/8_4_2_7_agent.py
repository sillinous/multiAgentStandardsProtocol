...
class Agent_8_4_2_7(AtomicAgentStandard):
    """
    Document systems

    APQC Task ID: 8.4.2.7
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.4.2.7",
            name="Document systems",
            description="APQC 8.4.2.7: Document systems"
        )
        self.apqc_id = "8.4.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '8.4.2.7',
                'task_name': 'Document systems',
                'category': 'Manage Information Technology',
            ...
            self.logger.info(f"Starting 8.4.2.7: Document systems")
            ...
            self.logger.info(f"Completed 8.4.2.7: Document systems in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.4.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
