...
class Agent_8_3_1_6(AtomicAgentStandard):
    """
    Optimize data

    APQC Task ID: 8.3.1.6
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.3.1.6",
            name="Optimize data",
            description="APQC 8.3.1.6: Optimize data"
        )
        self.apqc_id = "8.3.1.6"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.3.1.6: Optimize data")
            ...
            self.logger.info(f"Completed 8.3.1.6: Optimize data in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.3.1.6: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
