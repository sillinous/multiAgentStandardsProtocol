...
class Agent_8_2_1_8(AtomicAgentStandard):
    """
    Report security

    APQC Task ID: 8.2.1.8
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.2.1.8",
            name="Report security",
            description="APQC 8.2.1.8: Report security"
        )
        self.apqc_id = "8.2.1.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '8.2.1.8',
                'task_name': 'Report security',
                'category': 'Manage Information Technology',
            ...
            self.logger.info(f"Starting 8.2.1.8: Report security")
            ...
            self.logger.info(f"Completed 8.2.1.8: Report security in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.2.1.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
