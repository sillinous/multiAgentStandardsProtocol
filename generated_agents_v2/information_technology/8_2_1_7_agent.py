...
class Agent_8_2_1_7(AtomicAgentStandard):
    """
    Document security

    APQC Task ID: 8.2.1.7
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.2.1.7",
            name="Document security",
            description="APQC 8.2.1.7: Document security"
        )
        self.apqc_id = "8.2.1.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.2.1.7: Document security")
            ...
            self.logger.info(f"Completed 8.2.1.7: Document security in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.2.1.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
