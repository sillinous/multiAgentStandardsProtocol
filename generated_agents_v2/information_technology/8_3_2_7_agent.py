...
class Agent_8_3_2_7(AtomicAgentStandard):
    """
    Document technology

    APQC Task ID: 8.3.2.7
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.3.2.7",
            name="Document technology",
            description="APQC 8.3.2.7: Document technology"
        )
        self.apqc_id = "8.3.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.3.2.7: Document technology")
            ...
            self.logger.info(f"Completed 8.3.2.7: Document technology in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.3.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
