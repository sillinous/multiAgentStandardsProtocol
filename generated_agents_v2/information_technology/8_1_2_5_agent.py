...
class Agent_8_1_2_5(AtomicAgentStandard):
    """
    Review security

    APQC Task ID: 8.1.2.5
    Category: Manage Information Technology
    ...
    def __init__(self):
        super().__init__(
            agent_id="8.1.2.5",
            name="Review security",
            description="APQC 8.1.2.5: Review security"
        )
        self.apqc_id = "8.1.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 8.1.2.5: Review security")
            ...
            self.logger.info(f"Completed 8.1.2.5: Review security in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 8.1.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
