...
class Agent_13_4_1_8(AtomicAgentStandard):
    """
    Report governance

    APQC Task ID: 13.4.1.8
    Category: Develop and Manage Business Capabilities
    ...
    def __init__(self):
        super().__init__(
            agent_id="13.4.1.8",
            name="Report governance",
            description="APQC 13.4.1.8: Report governance"
        )
        self.apqc_id = "13.4.1.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 13.4.1.8: Report governance")
            ...
            self.logger.info(f"Completed 13.4.1.8: Report governance in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 13.4.1.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
