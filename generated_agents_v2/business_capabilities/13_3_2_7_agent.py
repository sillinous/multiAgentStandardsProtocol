...
class Agent_13_3_2_7(AtomicAgentStandard):
    """
    Document governance

    APQC Task ID: 13.3.2.7
    Category: Develop and Manage Business Capabilities
    ...
    def __init__(self):
        super().__init__(
            agent_id="13.3.2.7",
            name="Document governance",
            description="APQC 13.3.2.7: Document governance"
        )
        self.apqc_id = "13.3.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 13.3.2.7: Document governance")
            ...
            self.logger.info(f"Completed 13.3.2.7: Document governance in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 13.3.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
