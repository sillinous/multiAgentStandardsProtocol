"""
DefineAnalyticsObjectivesDevelopAgent - Standardized APQC Atomic Agent
================================================

APQC Task: 13.5.1.1 - Define analytics objectives
...
class DefineAnalyticsObjectivesDevelopAgentBusinessLogic(AtomicBusinessLogic):
    """
    Business logic for: Define analytics objectives

    This class implements the specific business logic for APQC task 13.5.1.1.
    ...
    def __init__(self, agent_id: str):
        ...
        self.base_template = BusinessLogicTemplateFactory.create_template(
            ...
            agent_id=agent_id,
            apqc_id="13.5.1.1",
            apqc_name="Define analytics objectives"
        )
        self.logger = logging.getLogger(f"DefineAnalyticsObjectivesDevelopAgent")
...
class DefineAnalyticsObjectivesDevelopAgent(StandardAtomicAgent):
    """
    Standardized Atomic Agent for: Define analytics objectives
    ...
    def declare_capability(self) -> AtomicCapability:
        ...
        return AtomicCapability(
            capability_id="cap_apqc_13_5_1_1_9776",
            capability_name="Define analytics objectives",
            description="Define analytics objectives - APQC 13.5.1.1",
            apqc_level5_id="13.5.1.1",
            apqc_level5_name="Define analytics objectives",
            apqc_category_id="13.0",
            apqc_category_name="Develop and Manage Business Capabilities",
    ...
    def create_business_logic(self) -> AtomicBusinessLogic:
        ...
        return DefineAnalyticsObjectivesDevelopAgentBusinessLogic(self.agent_id)
...
agent = DefineAnalyticsObjectivesDevelopAgent()

# Register with global registry
ATOMIC_AGENT_REGISTRY.register(agent)

# Export
__all__ = ['DefineAnalyticsObjectivesDevelopAgent', 'DefineAnalyticsObjectivesDevelopAgentBusinessLogic', 'agent']