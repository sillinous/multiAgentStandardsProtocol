...
class Agent_4_2_4_8(AtomicAgentStandard):
    """
    Report orders

    APQC Task ID: 4.2.4.8
    Category: Deliver Physical Products
    ...
    def __init__(self):
        super().__init__(
            agent_id="4.2.4.8",
            name="Report orders",
            description="APQC 4.2.4.8: Report orders"
        )
        self.apqc_id = "4.2.4.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '4.2.4.8',
                'task_name': 'Report orders',
                'category': 'Deliver Physical Products',
            ...
            self.logger.info(f"Starting 4.2.4.8: Report orders")
            ...
            self.logger.info(f"Completed 4.2.4.8: Report orders in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 4.2.4.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
