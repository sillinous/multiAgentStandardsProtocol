...
class Agent_4_2_4_7(AtomicAgentStandard):
    """
    Document orders

    APQC Task ID: 4.2.4.7
    Category: Deliver Physical Products
    ...
    def __init__(self):
        super().__init__(
            agent_id="4.2.4.7",
            name="Document orders",
            description="APQC 4.2.4.7: Document orders"
        )
        self.apqc_id = "4.2.4.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '4.2.4.7',
                'task_name': 'Document orders',
                'category': 'Deliver Physical Products',
            ...
            self.logger.info(f"Starting 4.2.4.7: Document orders")
            ...
            self.logger.info(f"Completed 4.2.4.7: Document orders in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 4.2.4.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
