...
class Agent_2_2_3_5(AtomicAgentStandard):
    """
    Review prototypes

    APQC Task ID: 2.2.3.5
    Category: Develop and Manage Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="2.2.3.5",
            name="Review prototypes",
            description="APQC 2.2.3.5: Review prototypes"
        )
        self.apqc_id = "2.2.3.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 2.2.3.5: Review prototypes")
            ...
            self.logger.info(f"Completed 2.2.3.5: Review prototypes in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 2.2.3.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
