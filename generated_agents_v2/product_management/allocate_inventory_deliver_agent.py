"""
AllocateInventoryDeliverAgent - Standardized APQC Atomic Agent
================================================

APQC Task: 4.5.2.3 - Allocate inventory
...
class AllocateInventoryDeliverAgentBusinessLogic(AtomicBusinessLogic):
    """
    Business logic for: Allocate inventory

    This class implements the specific business logic for APQC task 4.5.2.3.
    ...
    def __init__(self, agent_id: str):
        ...
        self.base_template = BusinessLogicTemplateFactory.create_template(
            ...
            agent_id=agent_id,
            apqc_id="4.5.2.3",
            apqc_name="Allocate inventory"
        )
        self.logger = logging.getLogger(f"AllocateInventoryDeliverAgent")
...
class AllocateInventoryDeliverAgent(StandardAtomicAgent):
    """
    Standardized Atomic Agent for: Allocate inventory
    ...
    def declare_capability(self) -> AtomicCapability:
        ...
        return AtomicCapability(
            capability_id="cap_apqc_4_5_2_3_5990",
            capability_name="Allocate inventory",
            description="Allocate inventory - APQC 4.5.2.3",
            apqc_level5_id="4.5.2.3",
            apqc_level5_name="Allocate inventory",
            apqc_category_id="4.0",
            apqc_category_name="Deliver Physical Products",
    ...
    def create_business_logic(self) -> AtomicBusinessLogic:
        ...
        return AllocateInventoryDeliverAgentBusinessLogic(self.agent_id)
...
agent = AllocateInventoryDeliverAgent()

# Register with global registry
ATOMIC_AGENT_REGISTRY.register(agent)

# Export
__all__ = ['AllocateInventoryDeliverAgent', 'AllocateInventoryDeliverAgentBusinessLogic', 'agent']