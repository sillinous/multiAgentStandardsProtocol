...
class Agent_2_2_3_8(AtomicAgentStandard):
    """
    Report prototypes

    APQC Task ID: 2.2.3.8
    Category: Develop and Manage Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="2.2.3.8",
            name="Report prototypes",
            description="APQC 2.2.3.8: Report prototypes"
        )
        self.apqc_id = "2.2.3.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '2.2.3.8',
                'task_name': 'Report prototypes',
                'category': 'Develop and Manage Products and Services',
            ...
            self.logger.info(f"Starting 2.2.3.8: Report prototypes")
            ...
            self.logger.info(f"Completed 2.2.3.8: Report prototypes in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 2.2.3.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
