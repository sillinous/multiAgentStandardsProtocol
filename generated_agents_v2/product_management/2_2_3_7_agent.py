...
class Agent_2_2_3_7(AtomicAgentStandard):
    """
    Document prototypes

    APQC Task ID: 2.2.3.7
    Category: Develop and Manage Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="2.2.3.7",
            name="Document prototypes",
            description="APQC 2.2.3.7: Document prototypes"
        )
        self.apqc_id = "2.2.3.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '2.2.3.7',
                'task_name': 'Document prototypes',
                'category': 'Develop and Manage Products and Services',
            ...
            self.logger.info(f"Starting 2.2.3.7: Document prototypes")
            ...
            self.logger.info(f"Completed 2.2.3.7: Document prototypes in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 2.2.3.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
