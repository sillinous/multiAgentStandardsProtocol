...
class Agent_2_3_2_5(AtomicAgentStandard):
    """
    Review prototypes

    APQC Task ID: 2.3.2.5
    Category: Develop and Manage Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="2.3.2.5",
            name="Review prototypes",
            description="APQC 2.3.2.5: Review prototypes"
        )
        self.apqc_id = "2.3.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '2.3.2.5',
                'task_name': 'Review prototypes',
                'category': 'Develop and Manage Products and Services',
            ...
            self.logger.info(f"Starting 2.3.2.5: Review prototypes")
            ...
            self.logger.info(f"Completed 2.3.2.5: Review prototypes in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 2.3.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
