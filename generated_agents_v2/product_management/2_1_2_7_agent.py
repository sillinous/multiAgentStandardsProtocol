...
class Agent_2_1_2_7(AtomicAgentStandard):
    """
    Document designs

    APQC Task ID: 2.1.2.7
    Category: Develop and Manage Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="2.1.2.7",
            name="Document designs",
            description="APQC 2.1.2.7: Document designs"
        )
        self.apqc_id = "2.1.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 2.1.2.7: Document designs")
            ...
            self.logger.info(f"Completed 2.1.2.7: Document designs in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 2.1.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
