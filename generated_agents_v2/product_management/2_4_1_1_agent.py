...
class Agent_2_4_1_1(AtomicAgentStandard):
    """
    Plan prototypes

    APQC Task ID: 2.4.1.1
    Category: Develop and Manage Products and Services
    ...
    def __init__(self):
        super().__init__(
            agent_id="2.4.1.1",
            name="Plan prototypes",
            description="APQC 2.4.1.1: Plan prototypes"
        )
        self.apqc_id = "2.4.1.1"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '2.4.1.1',
                'task_name': 'Plan prototypes',
                'category': 'Develop and Manage Products and Services',
            ...
            self.logger.info(f"Starting 2.4.1.1: Plan prototypes")
            ...
            self.logger.info(f"Completed 2.4.1.1: Plan prototypes in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 2.4.1.1: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
