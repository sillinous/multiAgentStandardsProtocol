...
class Agent_9_3_3_5(AtomicAgentStandard):
    """
    Review budgets

    APQC Task ID: 9.3.3.5
    Category: Manage Financial Resources
    ...
    def __init__(self):
        super().__init__(
            agent_id="9.3.3.5",
            name="Review budgets",
            description="APQC 9.3.3.5: Review budgets"
        )
        self.apqc_id = "9.3.3.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '9.3.3.5',
                'task_name': 'Review budgets',
                'category': 'Manage Financial Resources',
            ...
            self.logger.info(f"Starting 9.3.3.5: Review budgets")
            ...
            self.logger.info(f"Completed 9.3.3.5: Review budgets in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 9.3.3.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
