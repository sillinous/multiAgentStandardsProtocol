...
class Agent_9_3_2_5(AtomicAgentStandard):
    """
    Review controls

    APQC Task ID: 9.3.2.5
    Category: Manage Financial Resources
    ...
    def __init__(self):
        super().__init__(
            agent_id="9.3.2.5",
            name="Review controls",
            description="APQC 9.3.2.5: Review controls"
        )
        self.apqc_id = "9.3.2.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 9.3.2.5: Review controls")
            ...
            self.logger.info(f"Completed 9.3.2.5: Review controls in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 9.3.2.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
