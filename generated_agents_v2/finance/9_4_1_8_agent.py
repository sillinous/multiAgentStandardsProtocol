...
class Agent_9_4_1_8(AtomicAgentStandard):
    """
    Report controls

    APQC Task ID: 9.4.1.8
    Category: Manage Financial Resources
    ...
    def __init__(self):
        super().__init__(
            agent_id="9.4.1.8",
            name="Report controls",
            description="APQC 9.4.1.8: Report controls"
        )
        self.apqc_id = "9.4.1.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '9.4.1.8',
                'task_name': 'Report controls',
                'category': 'Manage Financial Resources',
            ...
            self.logger.info(f"Starting 9.4.1.8: Report controls")
            ...
            self.logger.info(f"Completed 9.4.1.8: Report controls in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 9.4.1.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
