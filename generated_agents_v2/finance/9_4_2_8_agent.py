...
class Agent_9_4_2_8(AtomicAgentStandard):
    """
    Report budgets

    APQC Task ID: 9.4.2.8
    Category: Manage Financial Resources
    ...
    def __init__(self):
        super().__init__(
            agent_id="9.4.2.8",
            name="Report budgets",
            description="APQC 9.4.2.8: Report budgets"
        )
        self.apqc_id = "9.4.2.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '9.4.2.8',
                'task_name': 'Report budgets',
                'category': 'Manage Financial Resources',
            ...
            self.logger.info(f"Starting 9.4.2.8: Report budgets")
            ...
            self.logger.info(f"Completed 9.4.2.8: Report budgets in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 9.4.2.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
