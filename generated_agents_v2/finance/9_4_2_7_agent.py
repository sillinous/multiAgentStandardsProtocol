...
class Agent_9_4_2_7(AtomicAgentStandard):
    """
    Document budgets

    APQC Task ID: 9.4.2.7
    Category: Manage Financial Resources
    ...
    def __init__(self):
        super().__init__(
            agent_id="9.4.2.7",
            name="Document budgets",
            description="APQC 9.4.2.7: Document budgets"
        )
        self.apqc_id = "9.4.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '9.4.2.7',
                'task_name': 'Document budgets',
                'category': 'Manage Financial Resources',
            ...
            self.logger.info(f"Starting 9.4.2.7: Document budgets")
            ...
            self.logger.info(f"Completed 9.4.2.7: Document budgets in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 9.4.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
