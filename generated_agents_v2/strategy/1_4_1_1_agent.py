...
class Agent_1_4_1_1(AtomicAgentStandard):
    """
    Plan objectives

    APQC Task ID: 1.4.1.1
    Category: Develop Vision and Strategy
    ...
    def __init__(self):
        super().__init__(
            agent_id="1.4.1.1",
            name="Plan objectives",
            description="APQC 1.4.1.1: Plan objectives"
        )
        self.apqc_id = "1.4.1.1"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '1.4.1.1',
                'task_name': 'Plan objectives',
                'category': 'Develop Vision and Strategy',
            ...
            self.logger.info(f"Starting 1.4.1.1: Plan objectives")
            ...
            self.logger.info(f"Completed 1.4.1.1: Plan objectives in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 1.4.1.1: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
