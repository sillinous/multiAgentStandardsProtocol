...
class Agent_1_4_2_1(AtomicAgentStandard):
    """
    Plan strategy

    APQC Task ID: 1.4.2.1
    Category: Develop Vision and Strategy
    ...
    def __init__(self):
        super().__init__(
            agent_id="1.4.2.1",
            name="Plan strategy",
            description="APQC 1.4.2.1: Plan strategy"
        )
        self.apqc_id = "1.4.2.1"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '1.4.2.1',
                'task_name': 'Plan strategy',
                'category': 'Develop Vision and Strategy',
            ...
            self.logger.info(f"Starting 1.4.2.1: Plan strategy")
            ...
            self.logger.info(f"Completed 1.4.2.1: Plan strategy in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 1.4.2.1: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
