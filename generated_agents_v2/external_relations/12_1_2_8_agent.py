...
class Agent_12_1_2_8(AtomicAgentStandard):
    """
    Report performance

    APQC Task ID: 12.1.2.8
    Category: Manage External Relationships
    ...
    def __init__(self):
        super().__init__(
            agent_id="12.1.2.8",
            name="Report performance",
            description="APQC 12.1.2.8: Report performance"
        )
        self.apqc_id = "12.1.2.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 12.1.2.8: Report performance")
            ...
            self.logger.info(f"Completed 12.1.2.8: Report performance in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 12.1.2.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
