...
class Agent_12_3_2_8(AtomicAgentStandard):
    """
    Report stakeholders

    APQC Task ID: 12.3.2.8
    Category: Manage External Relationships
    ...
    def __init__(self):
        super().__init__(
            agent_id="12.3.2.8",
            name="Report stakeholders",
            description="APQC 12.3.2.8: Report stakeholders"
        )
        self.apqc_id = "12.3.2.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '12.3.2.8',
                'task_name': 'Report stakeholders',
                'category': 'Manage External Relationships',
            ...
            self.logger.info(f"Starting 12.3.2.8: Report stakeholders")
            ...
            self.logger.info(f"Completed 12.3.2.8: Report stakeholders in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 12.3.2.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
