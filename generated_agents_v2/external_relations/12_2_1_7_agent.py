...
class Agent_12_2_1_7(AtomicAgentStandard):
    """
    Document performance

    APQC Task ID: 12.2.1.7
    Category: Manage External Relationships
    ...
    def __init__(self):
        super().__init__(
            agent_id="12.2.1.7",
            name="Document performance",
            description="APQC 12.2.1.7: Document performance"
        )
        self.apqc_id = "12.2.1.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 12.2.1.7: Document performance")
            ...
            self.logger.info(f"Completed 12.2.1.7: Document performance in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 12.2.1.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
