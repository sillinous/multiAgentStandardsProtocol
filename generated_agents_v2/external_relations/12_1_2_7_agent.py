...
class Agent_12_1_2_7(AtomicAgentStandard):
    """
    Document performance

    APQC Task ID: 12.1.2.7
    Category: Manage External Relationships
    ...
    def __init__(self):
        super().__init__(
            agent_id="12.1.2.7",
            name="Document performance",
            description="APQC 12.1.2.7: Document performance"
        )
        self.apqc_id = "12.1.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '12.1.2.7',
                'task_name': 'Document performance',
                'category': 'Manage External Relationships',
            ...
            self.logger.info(f"Starting 12.1.2.7: Document performance")
            ...
            self.logger.info(f"Completed 12.1.2.7: Document performance in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 12.1.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
