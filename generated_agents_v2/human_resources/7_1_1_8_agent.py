...
class Agent_7_1_1_8(AtomicAgentStandard):
    """
    Report performance

    APQC Task ID: 7.1.1.8
    Category: Manage Human Capital
    ...
    def __init__(self):
        super().__init__(
            agent_id="7.1.1.8",
            name="Report performance",
            description="APQC 7.1.1.8: Report performance"
        )
        self.apqc_id = "7.1.1.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 7.1.1.8: Report performance")
            ...
            self.logger.info(f"Completed 7.1.1.8: Report performance in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 7.1.1.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
