...
class Agent_7_1_2_7(AtomicAgentStandard):
    """
    Document compensation

    APQC Task ID: 7.1.2.7
    Category: Manage Human Capital
    ...
    def __init__(self):
        super().__init__(
            agent_id="7.1.2.7",
            name="Document compensation",
            description="APQC 7.1.2.7: Document compensation"
        )
        self.apqc_id = "7.1.2.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            result_data = {
                'apqc_task_id': '7.1.2.7',
                'task_name': 'Document compensation',
                'category': 'Manage Human Capital',
            ...
            self.logger.info(f"Starting 7.1.2.7: Document compensation")
            ...
            self.logger.info(f"Completed 7.1.2.7: Document compensation in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 7.1.2.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
