...
class Agent_7_2_2_8(AtomicAgentStandard):
    """
    Report benefits

    APQC Task ID: 7.2.2.8
    Category: Manage Human Capital
    ...
    def __init__(self):
        super().__init__(
            agent_id="7.2.2.8",
            name="Report benefits",
            description="APQC 7.2.2.8: Report benefits"
        )
        self.apqc_id = "7.2.2.8"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 7.2.2.8: Report benefits")
            ...
            self.logger.info(f"Completed 7.2.2.8: Report benefits in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 7.2.2.8: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
