...
class Agent_7_2_1_5(AtomicAgentStandard):
    """
    Review compensation

    APQC Task ID: 7.2.1.5
    Category: Manage Human Capital
    ...
    def __init__(self):
        super().__init__(
            agent_id="7.2.1.5",
            name="Review compensation",
            description="APQC 7.2.1.5: Review compensation"
        )
        self.apqc_id = "7.2.1.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 7.2.1.5: Review compensation")
            ...
            self.logger.info(f"Completed 7.2.1.5: Review compensation in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 7.2.1.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
