...
class Agent_7_3_3_5(AtomicAgentStandard):
    """
    Review workforce

    APQC Task ID: 7.3.3.5
    Category: Manage Human Capital
    ...
    def __init__(self):
        super().__init__(
            agent_id="7.3.3.5",
            name="Review workforce",
            description="APQC 7.3.3.5: Review workforce"
        )
        self.apqc_id = "7.3.3.5"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 7.3.3.5: Review workforce")
            ...
            self.logger.info(f"Completed 7.3.3.5: Review workforce in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 7.3.3.5: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
