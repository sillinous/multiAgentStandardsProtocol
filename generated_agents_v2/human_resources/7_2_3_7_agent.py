...
class Agent_7_2_3_7(AtomicAgentStandard):
    """
    Document training

    APQC Task ID: 7.2.3.7
    Category: Manage Human Capital
    ...
    def __init__(self):
        super().__init__(
            agent_id="7.2.3.7",
            name="Document training",
            description="APQC 7.2.3.7: Document training"
        )
        self.apqc_id = "7.2.3.7"
    ...
    async def execute_atomic_task(self, agent_input: AtomicAgentInput) -> AtomicAgentOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting 7.2.3.7: Document training")
            ...
            self.logger.info(f"Completed 7.2.3.7: Document training in {execution_duration:.2f}s")
            ...
            self.logger.error(f"Error executing 7.2.3.7: {e}")
            return AtomicAgentOutput(
                task_id=agent_input.task_id,
                agent_id=self.apqc_id,
